            ...
            <main className='flex flex-col gap-4 md:p-5 mb-8'>
                ...
                <div className='fixed z-20 top-0 left-0 md:py-1 md:px-5 w-full bg-black bg-opacity-20 backdrop-blur-md md:border-b border-neutral-700 grid md:grid-cols-3'>
                    ...
                    <div className='border-2 border-primary/50 rounded-sm p-0.5'>
                        <div className='border border-primary/30 p-0.5'>
                            <div className='py-1 px-2.5 flex md:flex-col md:justify-center justify-between gap-2 items-center md:text-center bg-primary/60'>
                                <div>
                                ...
                                <div className='relative ml-auto my-auto flex items-center gap-1 md:hidden'>
                                    <div>
                                        <audio
                                            ref={surahAudioRef}
                                            src={
                                                Object.values(data.audioFull)[4]
                                            }
                                        />
                                        <button
                                            onClick={playSurah}
                                        ...
                                        >
                                            <span className='bg-primary rounded-full p-0 absolute w-5/6 h-5/6 -z-10'></span>
                                            <Image
                                                src={
                                                    surahAudio
                                                        ? "/pause-button.png"
                                    ...
                                    <button
                                        className='rounded-full relative grid place-items-center'
                                        onClick={() => setIsOpen(true)}
                                    >
                                        <span className='bg-primary/60 rounded-full p-0 absolute w-5/6 h-5/6 -z-10'></span>
                                        <Image
                                    ...
                                    >
                                        <span className='bg-primary/60 rounded-full p-0 absolute w-5/6 h-5/6 -z-10'></span>
                                        <span
                                            className={`absolute content-[''] -rotate-45 w-8 h-0.5 bg-primary/60 z-20 left-0 rounded-full transition-all ${
                                                latin && "hidden"
                                            }`}
                                        ></span>
                                        <Image
                                            src='/images/latin-icon.png'
                                            width={32}
                                            height={32}
                                            alt='Options'
                                        />
                    ...
                    <div className='relative ml-auto my-auto flex items-center gap-1'>
                        ...
                        <button
                            className='hidden rounded-full relative md:grid place-items-center'
                            onClick={() => setIsOpen(true)}
                        >
                            <span className='bg-primary/60 rounded-full p-0 absolute w-5/6 h-5/6 -z-10'></span>
                            <Image
                        ...
                        >
                            <span className='bg-primary/60 rounded-full p-0 absolute w-5/6 h-5/6 -z-10'></span>
                            <span
                                className={`absolute content-normal -rotate-45 w-8 h-0.5 bg-red-500/60 z-20 left-0 rounded-full ${
                                    latin ? "" : ""
                                }`}
                            ></span>
                            <Image
                ...
                <div className='mt-20 pt-1 md:pt-0'>
                    ...
                    {data.ayat?.map((item, idx) => (
                        <div
                            key={idx}
                            className='relative w-full border-b border-neutral-500 px-3 md:px-0 pb-3.5 pt-6 grid grid-cols-12 gap-3'
                        >
                            <div className='col-span-1 md:pr-3 flex flex-col items-center gap-2'>
                                <span className='bg-primary/60 flex justify-center items-center md:w-9 md:h-9 w-8 h-8 px-1 py-0.5 rounded-full md:text-sm text-xs'>
                                    {item.nomorAyat}
                                </span>
                            </div>
                            <div className='col-span-11 w-full pl-2.5 pr-2 pt-1 md:pl-0'>
                                <p className='text-right leading-extra-loose text-lg md:text-xl xl:text-3xl mb-10'>
                                    {item.teksArab}
                                </p>
                                {latin && (
                    ...
                    <div className='pt-6 w-full flex justify-between gap-2 items-center my-auto'>
                        {data.suratSebelumnya && (
                            <Link
                                href={`${data.suratSebelumnya.nomor}`}
                                className='mr-auto inline-flex items-center gap-1 md:gap-2'
                            >
                                <Image
                                    src='/images/arrow.svg'
                                    width={20}
                        ...
                        {data.suratSelanjutnya && (
                            <Link
                                href={`${data.suratSelanjutnya.nomor}`}
                                className='ml-auto inline-flex items-center gap-1 md:gap-2'
                            >
                                <span className='text-sm md:text-base'>
                                    Surah selanjutnya
                                </span>
